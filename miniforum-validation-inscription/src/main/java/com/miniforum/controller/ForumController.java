...
import com.miniforum.dao.SujetRepository;
...
public class ForumController {
  ...
  //Méthode qui crée un nouveau sujet
    @PostMapping(value = "/nouveauSujet")
	public String createSubject(Model model, @RequestParam(value = "subjectTitle") String titre, @RequestParam(value = "summernote") String description) {
		...
		sujet.setIntensite(intensite);
		sujet.setTitre(titre);
		
		Message message = new Message(titre, date, description);
